...
class MS_SSIM(torch.jit.ScriptModule):
    ...
    def __init__(self, window_size=7, window_sigma=1.5, data_range=255., channel=3, use_padding=False, weights=None, levels=None, eps=1e-8):
        '''
        class for ms-ssim
        :param window_size: the size of gauss kernel
        :param window_sigma: sigma of normal distribution
...
def build_msssim_loss():
    return MS_SSIM(data_range=1.).cuda()
